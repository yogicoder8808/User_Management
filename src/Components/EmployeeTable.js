...
//     const updatedEmployee = { ...employees[index], profilePhoto: '' };
//     const updatedEmployees = [...employees.slice(0, index), updatedEmployee, ...employees.slice(index + 1)];
...
//                       <>
//                         <img src={employee.profilePhoto} alt="Profile" style={{ width: '50px', height: 'auto' }} />
//                         <Close onClick={() => handleRemoveProfilePic(index + page * rowsPerPage)} color="primary" style={{ position: 'absolute', top: '4px', right: '4px', backgroundColor: 'white', borderRadius: '50%' }} />
//                       </>
//                     ) : (
//                       <AccountCircle style={{ fontSize: '50px', color: '#bdbdbd' }} />
//                     )}
